...
--Info.nuevoEmpleado-----------------------------------------------------------------------------------
--Caso Exitoso
EXEC Info.nuevoEmpleado @nombre = 'Juan', @apellido = 'Pérez', @dni = 12345678, @direccion = 'Calle Falsa 123', @emailPersonal = 'juan.perez@gmail.com', @emailEmpresa = 'jperez@empresa.com', @cargo = 'Supervisor', @sucursal = 'Centro', @turno = 'M';
SELECT * FROM Info.Empleado; -- Verificar inserción

--Caso Fallido (Sucursal no encontrada)
EXEC Info.nuevoEmpleado @nombre = 'Juan', @apellido = 'Pérez', @dni = 12345678, @direccion = 'Calle Falsa 123', @emailPersonal = 'juan.perez@gmail.com', @emailEmpresa = 'jperez@empresa.com', @cargo = 'Supervisor', @sucursal = 'Inexistente', @turno = 'M';
